...
data class Move (
    val accuracy: Int,
    val contest_combos: kotlin.Any,
    val contest_effect: kotlin.Any,
    val contest_type: kotlin.Any,
    val damage_class: ObjNameUrl,
    val effect_chance: Int,
    val effect_changes: Array<kotlin.Any>,
    val effect_entries: Array<kotlin.Any>,
    val flavor_text_entries: Array<kotlin.Any>,
    val generation: kotlin.Any,
    val id: Int,
    val machine: Array<kotlin.Any>,
    val meta: kotlin.Any,
    val name: String,
    val names: Array<kotlin.Any>,
    val past_values: Array<kotlin.Any>,
    val power: Int,
    val pp: Int,
    val priority: Int,
    val stat_changes: Array<kotlin.Any>,
    val super_contest_effect: kotlin.Any,
